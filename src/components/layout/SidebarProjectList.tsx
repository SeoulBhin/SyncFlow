                      ...
                      <div key={page.id} className="group relative">
                        {deletingId === page.id ? (
                          <div className="flex items-center gap-1 rounded-lg bg-red-50 px-2 py-1 dark:bg-red-900/20">
                            ...
                            <button onClick={() => confirmDelete(page.id, page.name, isMock)} className="rounded p-0.5 text-error hover:text-red-700">
                              <Check size={12} />
                            </button>
                          </div>
                        ) : renamingId === page.id ? (
                          <div className="flex items-center gap-1 px-2 py-1">
                            ...
                            />
                            <button onClick={() => confirmRename(page.id)} className="rounded p-0.5 text-success hover:text-green-700">
                              <Check size={12} />
                            </button>
